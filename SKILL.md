...
description: AI 前沿广播 — 追踪 AI 领域顶尖实干家的 X/Twitter 动态和官方博客，生成智能双语摘要和长页 HTML 报告。当用户需要 AI 行业动态、builder 更新、或 invokes /ai 时使用。无需 API key。
---

# AI Broadcast Digest

追踪 AI 领域真正在构建产品、运营公司、做研究的人 — 来自 X/Twitter 和官方博客的第一手内容，自动生成可摘要的长页 HTML 报告。
...
If `stats.blogPosts` is 0 AND `stats.xTweets` is 0,
